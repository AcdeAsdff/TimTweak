...
public class ReturnReplacements {
    ...
    public static final byte[] byteArray114514 = new byte[]{(byte) random.nextInt(127),(byte) random.nextInt(127),(byte) random.nextInt(127),(byte) random.nextInt(127),(byte) random.nextInt(127),(byte) random.nextInt(127)};
