    ...
    public static void DoHook(XC_LoadPackage.LoadPackageParam lpparam){
        ...
        if (HookBilibiliClassFlag){
            if (lpparam.processName.split(":")[0].contains("tv.danmaku.bili")){
                HookerThread hook1 = new HookerThread(lpparam.classLoader,HookerThread.TIMHookedPackagesPart4);
                hook1.run();
                String rootName = "/sdcard/Android/data/tv.danmaku.bili/";
                try {
                    {
                        //all ads,DISAPPEAR!
                        hookClass = XposedHelpers.findClassIfExists("com.bilibili.pegasus.api.b0", lpparam.classLoader);
                        if (hookClass != null){
...
//                                            generalResponse.data.items = e(jSONArray);
                            ...
                            }
                            {
...

                                {
                                    ...
                                    XposedBridge.hookAllMethods(hookClass, "l", returnNull);
                                ...
                                }
                                {
                                    ...
                                    XposedBridge.hookAllMethods(hookClass, "N",returnNull);
                                    XposedBridge.hookAllMethods(hookClass, "J", new XC_MethodReplacement() {
                                        @Override
                                        protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
...
//                                }
                            ...
                            {
                                hookClass = XposedHelpers.findClassIfExists("com.mall.ui.page.blindbox.view.taskcard.data.repo.c",lpparam.classLoader);
                                if (hookClass != null){
                                    XposedBridge.hookAllMethods(hookClass,"a", new XC_MethodReplacement() {
                                        @Override
                                        protected Object replaceHookedMethod(MethodHookParam param) {
                            ...
                            {
                                hookClass = XposedHelpers.findClassIfExists("com.mall.data.page.create.submit.address.a",lpparam.classLoader);
                                if (hookClass != null){
                                    XposedBridge.hookAllMethods(hookClass,"f", new XC_MethodReplacement() {
                                        @Override
                                        protected Object replaceHookedMethod(MethodHookParam param) {
                                            return null;
                                        }
                            ...
                            {
                                hookClass = XposedHelpers.findClassIfExists("com.mall.common.context.n",lpparam.classLoader);
                                if (hookClass != null){
                                    XposedBridge.hookAllMethods(hookClass,"c", new XC_MethodReplacement() {
                                        @Override
                                        protected Object replaceHookedMethod(MethodHookParam param) {
                                            return null;
                                        }
                            ...
                            {
                                hookClass = XposedHelpers.findClassIfExists("com.bilibili.opd.app.bizcommon.sentinel.bilow.d",lpparam.classLoader);
                                if (hookClass != null){
                                    XposedBridge.hookAllMethods(hookClass,"enqueue", new XC_MethodReplacement() {
                                        @Override
                                        protected Object replaceHookedMethod(MethodHookParam param) {
...
//                            {
//                                hookClass = XposedHelpers.findClassIfExists(android.util.Log.class.getName(),lpparam.classLoader);
//                                if (hookClass != null){
//                                    XposedBridge.hookAllMethods(hookClass, "d", new XC_MethodHook() {
//                                        @Override
//                                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                                            super.beforeHookedMethod(param);
//                                            if (param.args[0].equals("mall_apicallback")){
//                                                LoggerLog(new Exception("not an exception"));
//                                            }
//                                        }
//                                    });
...
//                                            showObjectFields(param.args[0],"    ");//to check grab using now and fetch info
                            ...
                            {
                                hookClass = XposedHelpers.findClassIfExists("com.bilibili.lib.neuron.api.c",lpparam.classLoader);
                                if (hookClass !=null){
...
//                                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                                            super.beforeHookedMethod(param);
//                                            LoggerLog(new Exception("not an exception:constructor"));
//                                        }
//                                    });
...
//                                            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                                                super.beforeHookedMethod(param);
//                                                LoggerLog(new Exception("not an exception:" + m.getName()));
//                                            }
//                                        });
//                                    }
//                                }
//                            }
//                            hookClass = XposedHelpers.findClassIfExists("com.google.protobuf.CodedInputStreamReader",lpparam.classLoader);
//                            if (hookClass != null){
//                                XposedBridge.hookAllMethods(hookClass, "readMessage", new XC_MethodHook() {
//                                    @Override
//                                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
//                                        super.afterHookedMethod(param);
//                                        if (param.getResult().getClass().toString().equals("class com.bapis.bilibili.main.community.reply.v1.ReplyInfo")){
////                                            showObjectFields(param.getResult(),"    ");
//                                        }
////                                        LoggerLog(new Exception("not an exception:" + param.getResult().getClass()));
//                                    }
//                                });
//                            }
                        }
                    ...
                    {
                        {
                            hookClass = XposedHelpers.findClassIfExists("com.bilibili.base.util.DelayTaskController",lpparam.classLoader);
                            if (hookClass !=null){
                                findAndHookMethodIfExists(hookClass,"f", returnFalse);
                                findAndHookMethodIfExists(hookClass,"e", returnNull);
                            }
                            hookClass = XposedHelpers.findClassIfExists("tv.danmaku.bili.ui.main2.userprotocol.UserProtocolHelper",lpparam.classLoader);
                            if (hookClass != null){
                                XposedBridge.hookAllMethods(hookClass,"B", returnFalse);
                            }
                            hookClass = XposedHelpers.findClassIfExists("tv.danmaku.bili.ui.splash.service.a$a",lpparam.classLoader);
                            if (hookClass != null){
                                XposedBridge.hookAllMethods(hookClass,"a", returnNull);
                            }
                            hookClass = XposedHelpers.findClassIfExists("tv.danmaku.bili.MainActivityV2",lpparam.classLoader);
                            if (hookClass != null){
//                                for (Method m:hookClass.getDeclaredMethods()){
//                                    XposedBridge.hookMethod(m, new XC_MethodHook() {
//                                        @Override
//                                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                                            super.beforeHookedMethod(param);
//                                            LoggerLog(m.getName() + " : " + System.currentTimeMillis());
//                                        }
//                                    });
//                                }
                                XposedBridge.hookAllMethods(hookClass, "I9", new XC_MethodHook() {
                                    @Override
                                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                                        super.beforeHookedMethod(param);
                                        XposedHelpers.callMethod(param.thisObject,"Y9");
                                        XposedHelpers.callMethod(param.thisObject,"hideSplashFragment",false);
//                                        LoggerLog("I9/Y9 " + System.currentTimeMillis());
                                        param.setResult(null);
                                    }
                                });
                                XposedBridge.hookAllMethods(hookClass,"W9", returnTrue);
//                                XposedBridge.hookAllMethods(hookClass,"Y9", returnNull);//this directs to main page
                                XposedBridge.hookAllMethods(hookClass,"ca", returnNull);
                                XposedBridge.hookAllMethods(hookClass,"ba", returnNull);

                                XposedBridge.hookAllMethods(hookClass,"F9", returnNull);
                                XposedBridge.hookAllMethods(hookClass,"ra", returnNull);

                                XposedBridge.hookAllMethods(hookClass,"aa", returnTrue);
                                XposedBridge.hookAllMethods(hookClass,"isSplashFinish", returnFalse);
                                XposedBridge.hookAllMethods(hookClass,"L9", returnNull);


                            }
                            {
                                hookClass = XposedHelpers.findClassIfExists("tv.danmaku.bili.report.biz.main.DeviceInfoReporterKt",lpparam.classLoader);
                                if (hookClass != null){
                                    XposedBridge.hookAllMethods(hookClass,"b",returnNull);
                                    XposedBridge.hookAllMethods(hookClass,"c",returnNull);
                                }
                                hookClass = XposedHelpers.findClassIfExists("tv.danmaku.bili.report.biz.main.MisakaApmMainHelperKt",lpparam.classLoader);
                                if (hookClass != null){
                                    XposedBridge.hookAllMethods(hookClass,"c",returnNull);
                                }
                            }
                            String[] services = new String[]{
                                    ...
                                    "com.bilibili.lib.blrouter.internal.generated.Game_center",
                                    "com.bilibili.lib.blrouter.internal.generated.Game_tribe",
                                    "com.bilibili.lib.blrouter.internal.generated.Downloadgame_tribe",
                                    "com.bilibili.lib.blrouter.internal.generated.Ad",
                                    "com.bilibili.lib.blrouter.internal.generated.Adgame_tribe",
                                    "com.bilibili.lib.blrouter.internal.generated.Cloudgame_tribe",
                                    //👆I wont play games on it right now.

                                    "com.bilibili.lib.blrouter.internal.generated.SmallApp",//idk

                                    "com.bilibili.lib.blrouter.internal.generated.Mall",
                                    "com.bilibili.lib.blrouter.internal.generated.Mall_tribe",

                                    "com.bilibili.lib.blrouter.internal.generated.Bili_miui_relay",
//                                    "com.bilibili.lib.blrouter.internal.generated.Pegasus",//推荐
                                    "com.bilibili.lib.blrouter.internal.generated.Cheese",//idk
//                                    "com.bilibili.lib.blrouter.internal.generated.Device_config",
//                                    "com.bilibili.lib.blrouter.internal.generated.Device_settings",
                                    "com.bilibili.lib.blrouter.internal.generated._904298a70caf5bdc9807430f8163f6d5870d3e62",//splash...?
                                    "com.bilibili.lib.blrouter.internal.generated._ebcc2163ec068ae61ad2c25184b8d981e134b6c6",//with "*://debugger/setting/neuron_custom"
                            };
                            for (String serviceStr:services){
                                hookClass = XposedHelpers.findClassIfExists(serviceStr,lpparam.classLoader);
                                if (hookClass != null){
                                    XposedBridge.hookAllMethods(hookClass, "onRegister", returnNull);
                                }
                            }
                            hookClass = XposedHelpers.findClassIfExists("tv.danmaku.bili.moss.test.room.c",lpparam.classLoader);
                            if (hookClass != null){
                                XposedBridge.hookAllMethods(hookClass, "d",returnNull);
                            }

//                            hookClass = XposedHelpers.findClassIfExists("com.bilibili.lib.gripper.core.internal.task.DefaultTaskSubmitter",lpparam.classLoader);
//                            if (hookClass != null){
//                                XposedBridge.hookAllMethods(hookClass, "a", new XC_MethodHook() {
//                                    @Override
//                                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                                        super.beforeHookedMethod(param);
////                                        showArgs(param.args);
//                                        LoggerLog((String)XposedHelpers.getObjectField(param.args[0],"a"));
//                                        for (Object o:(Collection<Object>) param.args[1]){
//                                            LoggerLog((String) XposedHelpers.getObjectField(o,"a"));
//                                            String[] strArr = (String[]) XposedHelpers.getObjectField(o,"b");
...
//                            hookClass = XposedHelpers.findClassIfExists("tv.danmaku.bili.b$g$a",lpparam.classLoader);
//                            if (hookClass != null){
//                                XposedBridge.hookAllConstructors(hookClass, new XC_MethodHook() {
//                                    @Override
//                                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
...
//                            }
                    ...
                    if (HookClass != null){
                        ...
                        for (Method method : HookClass.getDeclaredMethods()) {
                            ...
                            if (returnType.equals(Void.TYPE)) {
                                ...
                                XposedBridge.hookMethod(
                                        method,returnLongZero
                                );
                            }
                            else if (returnType.equals(Integer.TYPE)) {
                                XposedBridge.hookMethod(
                                        method,returnIntegerZero
                                );
                            }
                            else if (returnType.equals(String.class)) {
                                XposedBridge.hookMethod(
...

                    {
                        hookClass = XposedHelpers.findClassIfExists("com.bapis.bilibili.main.community.reply.v1.ReplyInfo",lpparam.classLoader);
                        if (hookClass != null){
                            XposedBridge.hookAllMethods(hookClass,"getContent", new XC_MethodHook() {
                                @Override
                                protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                                    super.afterHookedMethod(param);
                                    XposedHelpers.setObjectField(
                                            param.getResult(),"urls_",
                                            XposedHelpers.getStaticObjectField(
                                                    XposedHelpers.findClass("com.google.protobuf.MapFieldLite",param.thisObject.getClass().getClassLoader()),"EMPTY_MAP_FIELD"
                                            )
                                    );
//                                    LoggerLog(new Exception("not an exception:" + XposedHelpers.getObjectField(param.getResult(),"message_")));
                                }
                            });
                        }
                    }
